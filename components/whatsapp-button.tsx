...
export function WhatsappButton() {
    const phoneNumber = "5531999999999" // TODO: Substituir pelo número real da Alissia
    const message = encodeURIComponent("Olá Alissia! Vi seu site e gostaria de agendar uma consulta.")
    ...
    return (
        ...
        >
            ...
            <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[#25D366]/40 backdrop-blur-sm border border-white/20">
